...
1. Open the notebook: [defi_sustainability_report.ipynb](https://github.com/GeorgeKGM2058/DeFi-Token-Sustainability-Analyzer/blob/main/defi_sustainability_report.ipynb).
...
| Emission Pressure      	| Heuristic combining supply overhang with TVL momentum: overhang / growth (if positive, floored at 5%); or (overhang x 2) + (|decline| x 2) (if negative). Capped at 10 for relative ranking. |
...
Full sample PDF: [defi_sustainability_report.pdf](path/to/sample_pdf.pdf)
